...
----------------------------------------------------------------------- getCRC()
	Function: getCRC(unsigned char *buf, int len, unsigned char *value);
	Purpose: Returns a CRC for a given length of bytes.
	Notes: None


-------------------------------------------------------------------- getCRCCont()
	Function: void getCRCCont(unsigned char restart, unsigned char *buf, int len, unsigned char *value);
