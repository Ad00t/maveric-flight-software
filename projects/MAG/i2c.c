...
unsigned int8 i2c_read_8(unsigned int8 add, unsigned int8 reg)
{
...
void i2c_write_8(unsigned int8 add, unsigned int8 reg, unsigned int8 write_data)
{
...
unsigned int16 i2c_read_16(unsigned int8 add, unsigned int8 reg)
{
...
void i2c_write_16(unsigned int8 add, unsigned int8 reg, unsigned int16 write_data)
{
...
void i2c_read_word(unsigned int8 add, unsigned int8 reg, unsigned int8 *output, unsigned int8 num_bytes)
{
	//I2C INA226 reading routine
	//int8(i2c address), int8(i2c register), -> int16
	//reads the bytes present in the i2c register of the addressed device and saves it on read_data 
