...
//=============================================
// Port 0
#define	U1TX_PIN    PIN_F2
#define	U1RX_PIN    PIN_F3 
...
// Port 3
#define	U4TX_PIN	PIN_D4      //CGC Testing
#define	U4RX_PIN	PIN_D12		//CGC Testing PIN_D12 IS INPUT ONLY AND CAN'T BE TX!!! <---- AHHH!!!
