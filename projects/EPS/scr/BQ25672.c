...
void bq25672_state(unsigned int8 add = BQ_ADDR, unsigned char *output, unsigned int16 reg = 0x00, unsigned int1 text=0)
{
	switch (reg)
	{
		...
		{	
			if (text)
			{
				sprintf(output,"%Lu", 2500 + 250 * i2c1_read_8(add, REG00_Minimal_System_Voltage));
			}
			else
			{
		...
		case 0x01:
		{
			if (text)
			{
				sprintf(output,"%Lu", 10 * i2c1_read_16(add, REG01_Charge_Voltage_Limit));
			}
			else
			{
		...
		case 0x03:
		{
			if (text)
			{
				sprintf(output,"%Lu", 10 * i2c1_read_16(add, REG03_Charge_Current_Limit));	
			}
			else
			{
		...
		case 0x05:
		{
			if (text)
			{
				sprintf(output,"%Lu", 100 * i2c1_read_8(add, REG05_Input_Voltage_Limit));	
			}
			else
			{
		...
		case 0x06:
		{
			if (text)
			{
				sprintf(output,"%Lu"   , 10 * i2c1_read_16(add, REG06_Input_Current_Limit));
			}
			else
			{
	    ...
	    case 0x08:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG08_Precharge_Control));
			}
			else
			{
		...
		case 0x09:
		{
			if (text)
			{
				sprintf(output,"%Lu"  , 40 * i2c1_read_8(add, REG09_Termination_Control));
			}
			else
			{
		...
		case 0x0A:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG0A_Recharge_Control));
			}
			else
			{
		...
		case 0x0B:
		{
			if (text)
			{
				sprintf(output,"%Lu", 2800 + 10 * i2c1_read_16(add, REG0B_VOTG_regulation));
			}
			else
			{
		...
		case 0x0D:
		{
			if (text)
			{
				sprintf(output,"%Lu", 40 * i2c1_read_8(add, REG0D_IOTG_regulation));
			}
			else
			{
		...
		case 0x0E:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG0E_Timer_Control));
			}
			else
			{
		...
		case 0x0F:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG0F_Charger_Control_0));
			}
			else
			{
		...
		case 0x10:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG10_Charger_Control_1));
			}
			else
			{
		...
		case 0x11:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG11_Charger_Control_2));
			}
			else
			{
		...
		case 0x12:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG12_Charger_Control_3));
			}
			else
			{
		...
		case 0x13:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG13_Charger_Control_4));
			}
			else
			{
		...
		case 0x14:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG14_Charger_Control_5));
			}
			else
			{
		...
		case 0x15:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG15_MPPT_Control));
			}
			else
			{
		...
		case 0x16:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG16_Temperature_Control));
			}
			else
			{
		...
		case 0x17:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG17_NTC_Control_0));
			}
			else
			{
		...
		case 0x18:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG18_NTC_Control_1));
			}
			else
			{
		...
		case 0x19:
		{
			if (text)
			{
				sprintf(output,"%Lu", 10 * i2c1_read_8(add, REG19_ICO_Current_Limit));
			}
			else
			{
		...
		case 0x1B:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG1B_Charger_Status_0));
			}
			else
			{
		...
		case 0x1C:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG1C_Charger_Status_1));
			}
			else
			{
		...
		case 0x1D:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG1D_Charger_Status_2));
			}
			else
			{
		...
		case 0x1E:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG1E_Charger_Status_3));
			}
			else
			{
		...
		case 0x1F:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG1F_Charger_Status_4));
			}
			else
			{
		...
		case 0x20:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG20_FAULT_Status_0));
			}
			else
			{
	    ...
	    case 0x21:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG21_FAULT_Status_1));
			}
			else
			{
		...
		case 0x22:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG22_Charger_Flag_0));
			}
			else
			{
		...
		case 0x23:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG23_Charger_Flag_1));
			}
			else
			{
		...
		case 0x24:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG24_Charger_Flag_2));
			}
			else
			{
		...
		case 0x25:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG25_Charger_Flag_3));
			}
			else
			{
		...
		case 0x26:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG26_FAULT_Flag_0));
			}
			else
			{
		...
		case 0x27:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG27_FAULT_Flag_1));
			}
			else
			{
		...
		case 0x28:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG28_Charger_Mask_0));
			}
			else
			{
		...
		case 0x29:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG29_Charger_Mask_1));
			}
			else
			{
		...
		case 0x2A:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG2A_Charger_Mask_2));
			}
			else
			{
		...
		case 0x2B:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG2B_Charger_Mask_3));
			}
			else
			{
		...
		case 0x2C:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG2C_FAULT_Mask_0));
			}
			else
			{
		...
		case 0x2D:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG2D_FAULT_Mask_1));
			}
			else
			{
		...
		case 0x2E:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG2E_ADC_Control));
			}
			else
			{
		...
		case 0x2F:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG2F_ADC_Function_Disable_0));
			}
			else
			{
		...
		case 0x30:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG30_ADC_Function_Disable_1));
			}
			else
			{
		...
		case 0x31:
		{
			if (text)
			{
				sprintf(output,"%Ld", i2c1_read_16(add, REG31_IBUS_ADC));
				//sprintf(output,"%Ld", i2c1_read_16(add, REG31_IBUS_ADC));
		...
		case 0x33:
		{
			if (text)
			{
				sprintf(output,"%Ld", i2c1_read_16(add, REG33_IBAT_ADC));
			}
			else
			{
		...
		case 0x35:
		{
			if (text)
			{
				sprintf(output,"%Ld", i2c1_read_16(add, REG35_VBUS_ADC));
			}
			else
			{
		...
		case 0x37:
		{
			if (text)
			{
				sprintf(output,"%Ld", i2c1_read_16(add, REG37_VAC1_ADC));
			}
			else
			{
		...
		case 0x39:
		{
			if (text)
			{
				//sprintf(output,"%Ld", i2c1_read_16(add, REG39_VAC2_ADC));
				sprintf(output,"%Ld", i2c1_read_16(add, REG39_VAC2_ADC));
				//sprintf(output,output);
			}
			else
		...
		case 0x3B:
		{
			if (text)
			{
				sprintf(output,"%Lu", i2c1_read_16(add, REG3B_VBAT_ADC));
			}
			else
			{
		...
		case 0x3D:
		{
			if (text)
			{
				sprintf(output,"%Ld", i2c1_read_16(add, REG3D_VSYS_ADC));
			}
			else
			{
		...
		case 0x3F:
		{
			if (text)
			{
				sprintf(output,"%f", 0.0976563 * i2c1_read_16(add, REG3F_TS_ADC));
			}
			else
			{
		...
		case 0x41:
		{
			if (text)
			{
				sprintf(output,"%f", 0.5 * i2c1_read_16(add, REG41_TDIE_ADC));
			}
			else
			{
		...
		case 0x43:
		{
			if (text)
			{
				sprintf(output,"%Lu", i2c1_read_16(add, REG43_Dp_ADC));
			}
			else
			{
		...
		case 0x45:
		{
			if (text)
			{
				sprintf(output,"%Lu", i2c1_read_16(add, REG45_Dm_ADC));
			}
			else
			{
		...
		case 0x47:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG47_DPDM_Driver));
			}
			else
			{
		...
		case 0x48:
		{
			if (text)
			{
				sprintf(output,"%X", i2c1_read_8(add, REG48_Part_Infotmation)); 
			}
			else
			{
