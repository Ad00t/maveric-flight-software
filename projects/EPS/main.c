...
#else
	i2c1_write_16(INA226_ADDRESS_8, INA226_REG_CALIBRATION, 0x1400);
	i2c1_write_16(INA226_ADDRESS_7, INA226_REG_CALIBRATION, 0x1400);
	i2c1_write_16(INA226_ADDRESS_6, INA226_REG_CALIBRATION, 0x1400);
	i2c1_write_16(INA226_ADDRESS_5, INA226_REG_CALIBRATION, 0x1400);
	i2c1_write_16(INA226_ADDRESS_4, INA226_REG_CALIBRATION, 0x1400);
	i2c1_write_16(INA226_ADDRESS_3, INA226_REG_CALIBRATION, 0x1400);
	i2c1_write_16(INA226_ADDRESS_2, INA226_REG_CALIBRATION, 0x1400);
	i2c1_write_16(INA226_ADDRESS_1, INA226_REG_CALIBRATION, 0x1400);
	i2c1_write_16(INA226_ADDRESS_12, INA226_REG_CALIBRATION, 0x1400);
	i2c1_write_16(INA226_ADDRESS_13, INA226_REG_CALIBRATION, 0x1400);
	//3.3V Bus
	//N/A
	//5V Bus
	//N/A
...
void power_set_test(int pin, unsigned int8 add)
{
	...
	//Configure routine
	ina226_rdata = i2c1_read_16(add, INA226_REG_CONFIG);
	...
	printf("Configuration Register: %LX\n\r", ina226_rdata);
	//Calibration routine
	ina226_rdata = i2c1_read_16(add, INA226_REG_CALIBRATION);
	printf("Writing: %LX, Calibration Register: %LX\n\r", ina226_wdata, ina226_rdata);
	ina226_wdata = 0x1400;
	i2c1_write_16(add, INA226_REG_CALIBRATION, ina226_wdata);
	ina226_rdata = i2c1_read_16(add, INA226_REG_CALIBRATION);
	printf("Writing: %LX, Calibration Register: %LX\n\r", ina226_wdata, ina226_rdata);
	...
	ina226_read_data(add, &shunt_voltage, &bus_voltage, &power, &current);
	printf("Shunt voltage: %Ld, Bus voltage: %Ld, Power: %Ld, Current: %Ld\n\r", shunt_voltage, bus_voltage, power, current);
	ina226_rdata = i2c1_read_16(add, INA226_REG_ID);
