...
//------------------------------------------------------------------------
	...
	ReturnErr_t flashCopy(unsigned long source_addr, unsigned long dest_addr, unsigned long len);	// Copies data from 1 address in flash to another.  Can return failure if len is too large, or if area to be written is not empty.
